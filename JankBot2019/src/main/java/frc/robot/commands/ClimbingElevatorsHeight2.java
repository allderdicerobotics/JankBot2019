...
public class ClimbingElevatorsHeight2 extends CommandGroup {
  /**
   * Add your docs here.
   */
  public ClimbingElevatorsHeight2() {
    requires(Robot.frontClimbingElevator);
    requires(Robot.backClimbingElevator);

    addParallel(new FrontClimbingElevatorHeight2());
    addSequential(new BackClimbingElevatorHeight2());
    // Add Commands here:
