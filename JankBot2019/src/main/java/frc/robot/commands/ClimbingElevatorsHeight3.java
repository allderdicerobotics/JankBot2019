...
public class ClimbingElevatorsHeight3 extends CommandGroup {
  /**
   * Add your docs here.
   */
  public ClimbingElevatorsHeight3() {
    requires(Robot.frontClimbingElevator);
    requires(Robot.backClimbingElevator);

    addParallel(new FrontClimbingElevatorHeight3());
    addSequential(new BackClimbingElevatorHeight3());
    // Add Commands here:
